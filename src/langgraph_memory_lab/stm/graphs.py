...
def build_trimming_stm_graph(
    *, policy: Optional[TrimPolicy] = None, checkpointer: Optional[Any] = None
) -> Any:
...
def build_deletion_stm_graph(
    *, policy: Optional[DeletionPolicy] = None, checkpointer: Optional[Any] = None
) -> Any:
...
def build_summarization_stm_graph(
    *, policy: Optional[SummarizationPolicy] = None, checkpointer: Optional[Any] = None
) -> Any:
